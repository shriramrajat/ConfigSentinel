...
def test_mapping_api_propose_not_implemented():
    """Verify that the real API endpoint properly wraps the NotImplementedError."""
    # Using the real router instance which has the real AIMapper
    ...
    assert "AI integration is not implemented" in response.json()["detail"]
